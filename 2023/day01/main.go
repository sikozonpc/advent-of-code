...
import (
	"sikozonpc/advent-of-code/utils"
	"strings"
	"unicode"
)

func SolvePartOne() int {
	chunks := strings.Split(input01, "\n")

	var total int

	for _, l := range chunks {
		curTotal := getChunksSum(l)
...
func getChunksSum(l string) int {
	var first int
	var last int
